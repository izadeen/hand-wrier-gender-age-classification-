...
class AgeClassifier:
    ...
    def train(self, trainData, testData, num_epochs, learningRate, weight_decay, modelName):
        optimizer = torch.optim.Adam(self.model.parameters(), lr=learningRate, weight_decay=weight_decay)
        ...
        return {"train acc": trainAcc, 'val acc': valAcc, \
                'train loss': losses, 'val los': valLoss}
